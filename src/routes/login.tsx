    ...
    <AppShell>
      <div className="max-w-md mx-auto card-pop p-8">
        ...
        <p className="text-muted-foreground text-sm">
          Prototype: any password works if the email matches a seeded or created account.
        </p>
        <form
        ...
        >
          ...
          <button className="btn-pop btn-pop-hover bg-primary text-primary-foreground w-full py-3 text-lg">
            Log in
          </button>
        </form>
